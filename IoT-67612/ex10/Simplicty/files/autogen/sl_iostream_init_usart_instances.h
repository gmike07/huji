...
extern sl_iostream_t *sl_iostream_gps_handle;
extern sl_iostream_uart_t *sl_iostream_uart_gps_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_gps_info;
