...
int SetupInternetServiceProfileAddr(char *cmd_buf, char *IP, int port, int keepintvl_sec)
{
    ...
    printf("Cellular: Setting address\n");
...
int OpenInternetConnection()
{
    ...
    printf("Cellular: Opening internet connection\n");
    ...
    printf("Cellular: Opening internet connection result: %s\n", serial_buf);
...
int CloseInternetConnection()
{
    ...
    printf("Cellular: Closing internet connection\n");
    ...
    printf("Cellular: Closing internet connection result: %s\n", serial_buf);
...
int WaitUntilServiceProfileIsUp()
{
    ...
    for (i = 0; i < INT_SERV_UP_ATTEMPTS; i++)
    {
        ...
        printf("Cellular: Internet service response: %s\n", serial_buf);
        ...
        {
            printf("Cellular: Internet service is not up, yet\n");
            sleep(INT_SERV_UP_ATTEMPT_SEC);
            continue;
        }
        ...
        {
            printf("Cellular: Internet service is up. State: %d\n", state);
            return SUCCESS_CODE;
        }

        printf("Cellular: Internet service is not up, yet. Current state: %d\n", state);
    ...
    printf("Cellular: Internet service is not up. Failed connecting\n");
...
int OpenTransparentSocket()
{
    ...
    printf("Cellular: Opening transparent socket\n");
...
int ExitTransparentSocket()
{
    ...
    printf("Cellular: Exiting transparent socket\n");
    n = SendCmdRecvRespWithWait(cmd_exit_transparent_socket, serial_buf, MEDIUM_RESPONSE_BUF_SIZE, SHORT_TIMEOUT);
    ...
    printf("Cellular: Exiting internet connection result: %s\n", serial_buf);
