...
//     // See discussion here: https://narkive.com/4BCPO8ce
//     // option #1:
//     //tcgetattr(g_fd, &SerialPortSettings); // get the current settings of the serial port
//     // option #2:
//     memset(&SerialPortSettings, 0, sizeof(SerialPortSettings)); // clear struct for new port settings
...
//     // Configuring this information involves setting and clearing individual bits of the control flags.
